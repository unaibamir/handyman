                    ...
                    <div class="ibox-content border-bottom row">
                        ...
                        {!! Form::model($category, [
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">Name</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name" placeholder="Please enter name" required value="{{ $category->name }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">Description</label>
                                <div class="col-sm-10">
                                    <textarea name="description" id="description" cols="30" rows="4" class="form-control" required>{{ $category->description }}</textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">Icon Type</label>
                                <div class="col-sm-10">
                                    <select name="icon_type" id="icon_type" class="select2 icon_type">
                                        ...
                                        <option value="image" {{ ($category->icon_type == 0) ? 'selected' : '' }}>Image</option>
                                        <option value="font" {{ ($category->icon_type == 1) ? 'selected' : '' }}>Font Icon</option>
                                    </select>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                                ...
                                <div class="col-sm-10">
                                    <select name="icon_font" id="icon_font" class="fa custom-select icon_font">
                                        ...
                                        foreach ($icons as $key => $icon) {
                                            ...
                                            echo '<option '.($category->icon==$key ? 'selected' : '').' value="'.$key.'">&#x'.$icon.' &nbsp;&nbsp;'.$key.'</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
