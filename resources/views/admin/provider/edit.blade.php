        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <!-- <?php echo '<pre>'.print_r($provider, true).'</pre>'; ?> -->

                        {!! Form::model($provider, [
                            'method' => 'PUT',
                            'route' => ['admin.client.update', $provider->id],
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Username <small class="text-danger"><sup>*</sup></small></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="username" requried value="{{$provider->username}}" readonly="readonly">
                            </div>
                        </div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">First Name <small class="text-danger"><sup>*</sup></small></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="fname" required value="{{$provider->fname}}">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Last Name <small class="text-danger"><sup>*</sup></small></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="lname" required value="{{$provider->lname}}">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Email <small class="text-danger"><sup>*</sup></small></label>
                            <div class="col-sm-10">
                                <input type="email" class="form-control" name="email" required value="{{$provider->email}}">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            ...
                            @if($provider->user_thumb != '')
                                <div class="col-sm-6">
                                    <input type="file" name="user_image" value="{{ $provider->user_image }}" id="user_image" class="form-control">
                                </div>
                                <div class="col-sm-4 text-center">
                                    <img src="{{ asset($provider->user_thumb) }}" class="img-responsive img-thumbnail img-circle" style="max-width: 150px;">
                                </div>
                            @else
                                <div class="col-sm-10">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Bio</label>
                            <div class="col-sm-10">
                                <textarea name="bio" class="form-control" cols="30" rows="4">{{$provider->bio}}</textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                            ...
                            <div class="col-sm-10">
                                <select class="form-control m-b select2" name="state">
                                    ...
                                    @foreach($states as $short => $name)
                                        <option value="{{ $name }}" <?php if($provider->state == $name) {echo 'selected';} ?>>{{ $name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Postal Code <small class="text-danger"><sup>*</sup></small></label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="postcode" id="postcode" required value="{{$provider->postcode}}">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                            ...
                            <div class="col-sm-10">
                                <fieldset class="gllpLatlonPicker" id="custom_id">
                                    <div class="input-group">
                                        <input type="text" class="gllpSearchField form-control" required name="location" value="{{$provider->location}}">
                                    ...
                                    <input type="hidden" name="latitude" class="gllpLatitude" value="{{$provider->latitude}}" />
                                    <input type="hidden" name="longitude" class="gllpLongitude" value="{{$provider->longitude}}"/>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Status</label>
                            <div class="col-sm-10">
                                <select class="form-control m-b select2" name="is_active">
                                    <option value="">Please Select</option>
                                    <option value="1" <?php if($provider->is_active == 1) {echo 'selected';} ?>>Active</option>
                                    <option value="0" <?php if($provider->is_active == 0) {echo 'selected';} ?>>Deactive</option>
                                </select>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Approved</label>
                            <div class="col-sm-10">
                                <select class="form-control m-b select2" name="is_approved">
                                    <option value="">Please Select</option>
                                    <option value="1" <?php if($provider->is_approved == 1) {echo 'selected';} ?>>Yes</option>
                                    <option value="0" <?php if($provider->is_approved == 0) {echo 'selected';} ?>>No</option>
                                </select>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
