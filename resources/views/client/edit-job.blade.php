                            ...
                            <div class="widget">
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="post-job-box col-md-10 col-md-offset-1">
                                        ...
                                        <form class="row validate_form" method="post" action="{{ route('client.update-job', $job->id) }}">
                                            {{ csrf_field() }}
                                            {{ method_field('PUT') }}
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control field" name="job_title" id="job_title" placeholder="Job Title" required value="{{ $job->title }}">
                                                </div>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control field" name="job_phone" id="job_phone" placeholder="Phone" required value="{{ $job->phone }}">
                                                </div>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control field job_location" name="job_location" id="job_location" placeholder="Address" required value="{{ $job->address }}">
                                                </div>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control field" name="job_time" id="job_time" placeholder="Suitable Time to Approach" required value="{{ $job->time }}">
                                                </div>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    <label class="sr-only" for="">Date</label>
                                                    <input type="text" class="form-control field" name="job_end_date" id="job_end_date" placeholder="Job End date" required value="{{$job->end_date}}">
                                                </div>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="job_type" id="job_pro_rate" class="option form-control field" required>
                                                        <option value="any"{{ $job->job_type == '' ? "selected" : "" }}>Job Type</option>
                                                        <option value="any"{{ $job->job_type == 'any' ? "selected" : "" }}>Any</option>
                                                        <option value="hourly{{ $job->job_type == 'hourly' ? "selected" : "" }}">Hourly</option>
                                                        <option value="fixed"{{ $job->job_type == 'fixed' ? "selected" : "" }}>Fixed</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="exp_level" id="job_pro_rate" class="option form-control field" required>
                                                        <option value="any" {{ $job->exp_level == '' ? "selected" : "" }}>Experience Level</option>
                                                        <option value="any"{{ $job->exp_level == 'any' ? "selected" : "" }}>Any</option>
                                                        <option value="entry"{{ $job->exp_level == 'entry' ? "selected" : "" }}>Entry Level</option>
                                                        <option value="inter"{{ $job->exp_level == 'inter' ? "selected" : "" }}>Intermediate</option>
                                                        <option value="exp"{{ $job->exp_level == 'exp' ? "selected" : "" }}>Expert</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="job_category" id="job_category" class="option form-control field  job_category" required>
                                                        ...
                                                        @foreach($categories as $key => $category)
                                                            <option value="{{ $category->id }}" {{ $category->id == $job->cat_id ? "selected" : "" }}>
                                                                {{ $category->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                ...
                                                <textarea class="form-control field" rows="16" cols="40" name="job_desc" id="job_desc" placeholder="Job Description" required>{!! $job->desc !!}</textarea>
